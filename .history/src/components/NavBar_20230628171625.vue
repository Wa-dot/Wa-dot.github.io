<template>
    <nav>
        ...
        <ul class="nav-links">
            ...
            <li>
                <router-link to="/contact" class="unline-center">{{ $t("nav.contact") }}</router-link>
            </li>
            <li class="lang"><router-link to="/contact" class="unline-center"><img src="/france.svg" alt="lang fr"></router-link></li>
        </ul>
