<template>
  <div class="slider-container">
    <div class="slider">
      <div class="slides">
        <!-- <div class="text-box slides" v-for="items in this.nbOfProducts" :id=items>
        ...
        <div v-for="items in this.nbOfProducts" :id=productId[items] class="slide">
          <span class="slide__text">1</span>
          <a class="slide__prev" href={{this.productIdLink[items++]}} title="Prev"></a>
          <a class="slide__next" href={{this.productIdLink[items--]}} title="Next"></a>
        </div>
      </div>
