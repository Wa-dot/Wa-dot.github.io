<template>
    <nav>
        ...
        <ul class="nav-links">
            ...
            <img v-if="this.$i18n.locale === 'fr'" src="/france.svg" alt="lang fr" class="lang" @click="changeLanguage()">
            <img v-if src="/us.svg" alt="lang fr" class="lang" @click="changeLanguage()">
        </ul>
