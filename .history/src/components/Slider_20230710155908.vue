...
<template>
    <div class="carousel">
        <div class="carousel-content">
            <button class="carousel-button -prev" @click="prev"><svg width="100" height="100">
                    <circle cx="50" cy="50" r="40" stroke="black" stroke-width="3" fill="none" />
                    <line x1="80" y1="50" x2="20" y2="50" stroke="black" stroke-width="3" />
                    <line x1="40" y1="30" x2="20" y2="50" stroke="black" stroke-width="3" />
                    <line x1="40" y1="70" x2="20" y2="50" stroke="black" stroke-width="3" />
                </svg>
            </button>
            ...
            <button class="carousel-button -next" @click="next"><svg width="100" height="100">
                    <circle cx="50" cy="50" r="40" stroke="black" stroke-width="3" fill="none" />
                    <line x1="20" y1="50" x2="80" y2="50" stroke="black" stroke-width="3" />
                    <line x1="60" y1="30" x2="80" y2="50" stroke="black" stroke-width="3" />
                    <line x1="60" y1="70" x2="80" y2="50" stroke="black" stroke-width="3" />
                </svg></button>
        </div>
    </div>
</template>
