    ...
    <div id="contact-form">
        ...
        <div id="contact-info">
            <div class="info-block" id="tel-block">
                <h2>{{ $t("contact.tel") }}</h2>
                <p @click="copyPhoneNumber" class="copy">{{ this.telReceiver }}   <svg viewBox="0 0 24 24" width="15px" height="15  px">
                        <path
            ...
            <div class="info-block" id="address-block">
                ...
                <p>{{ this.address }}<br>{{ this.postalCode }} {{ this.city }}<br>{{ this.country }}</p>
            </div>
        </div>
...
export default {
    ...
    methods: {
        ...
        callUs() {
            window.location.href = "tel:" + this.telReceiver;
        },
        copyPhoneNumber() {
